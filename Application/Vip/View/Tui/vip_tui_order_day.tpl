...
<div style="position:absolute;bottom:54px;z-index:9999999;background:#f24646;color:#FFF;width:100%;line-height:3rem;text-align:center;" class="jump" data-url="/vip/tui/order_detail?phone={{$phone}}&time_day={{$time_day}}">
	总订单记录
</div>
