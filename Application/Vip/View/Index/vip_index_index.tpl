    ...
    <div class="mui-row" style="background:#fff url(/Public/Images/Home/userbg.jpg) no-repeat center top;background-size:100% 8rem; padding-top:8rem;">
        ...
        <div class="mui-col-sm-12 mui-col-xs-12 mui-text-center" style=" margin-top:-3.2rem">
	          ...
	          <div class="mui-col-sm-12 mui-col-xs-12" style="text-align:center;">
	          		<img src="{{$output.member.headimgurl}}?imageView2/1/w/80/h/80" style="width: 6rem;border-radius:50%;" />
	        	</div>
...
.li{width:33%;float:left;text-align:center;font-size:0.75rem; color:#333; opacity:0.8; line-height:2.2rem;}
    ...
    <div class="mui-row" style=" padding-bottom:60px;">
        ...
        <div class="mui-col-sm-3 mui-col-xs-4" style="background:#FFF;border-bottom:1px solid #E9E9E9; border-right:1px #eeeeee solid;">
        	<a href="/order/orderList?phone={{$output.member.phone}}"><div style="  padding:0.6rem;width:3rem;height:3rem;margin:0.8rem auto 0.1rem; display:block;"><img class="mui-media-object" src="/Public/Images/Home/db1.png" style="width:1.8rem;height:1.8rem;"></div>
        ...
        <div class="mui-col-sm-3 mui-col-xs-4" style="background:#FFF;border-bottom:1px solid #E9E9E9; border-right:1px #eeeeee solid;">
        	<a href="/Vip/Tui/index?phone={{$output.member.phone}}"><div style=" padding:0.6rem;width:3rem;height:3rem;margin:0.8rem auto 0.1rem; display:block;"><img class="mui-media-object" src="/Public/Images/Home/db4.png" style="width:1.8rem;height:1.8rem;"></div>
       ...
       <eq name="output.tui_type"  value="1">
        <div class="mui-col-sm-3 mui-col-xs-4" style="background:#FFF;border-bottom:1px solid #E9E9E9; border-right:1px #eeeeee solid;">
        	<a href="/Vip/Tui/tui_advance?phone={{$output.member.phone}}"><div style=" padding:0.6rem;width:3rem;height:3rem;margin:0.8rem auto 0.1rem; display:block;"><img class="mui-media-object" src="/Public/Images/Home/db5.png" style="width:1.8rem;height:1.8rem;"></div>
