...
<style>
    .nhead { width:100%; height:38px; background:#f24646;border-bottom:1px #fff solid;position: relative;
        z-index:99999;}
       ...
       <div style=" position: absolute; top: 40%;left: 50%;margin-left:-1.41rem;margin-top: -1.55rem; z-index: 30; font-size: .16rem;" class="interval-pop">
        <div style="border-radius:.05rem ; padding-top:.25rem; width:2.82rem;height:2.51rem;background-color: #fff;" class="interval-pop-box">
        	<p>
	         ...
	         <span style="color: #f30;display:block;width:100%;height:.04rem;margin-top: .1rem; visibility: inherit;" id="error"></span>
	        		
          	 <form style="text-align: center;margin-top:-.2rem;" method="post" action="/Vip/Snatch/login" name="payPassword" id="form_paypsw">
					...
					<div style="display: inline-block;" class="i-block" data-error="i_error">
						<div style="margin-top: .5rem;margin-bottom:.3rem;">
							...
							<div class="i-block six-password">
								<input  style="margin-left:1.2rem;height:.4rem;width:1000px; left:-800px;" class="i-text sixDigitPassword" id="payPassword_rsainput" type="tel" autocomplete="off" required value="" name="payPassword_rsainput" data-role="sixDigitPassword" tabindex="" maxlength="6" minlength="6" aria-required="true">
				...
				<div style="width: 100%;position: relative;height: .4rem;line-height: .4rem;">
					<!-- <a href="javascript:;" style="display:inline-block;color:#999;position: absolute;left: 0rem;"> 修改密码</a> -->
					<a href="/Vip/Snatch/repwd" style="display:inline-block;color:#999;position: absolute;right: 0rem;"> 忘记密码！</a>
				</div>
				<a style="display:block;border-radius:.05rem; background: #f24646; color: #fff; height:.4rem;line-height:.4rem;font-size:.15rem;border: none;width: 90%;margin: .2rem auto;" href="javascript:;" onclick="login();">确认</a>
				<!--<input style="border-radius:.05rem; background: #db3652; color: #fff; height:.4rem; font-size:.18rem; border: none;width: 45%;margin: .2rem auto;" type="submit" value="取消">-->
       		</form>
      	 </div>  
    </div>
    </div>
