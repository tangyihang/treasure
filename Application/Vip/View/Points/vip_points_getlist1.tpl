...
<div id="pullrefresh" class="mui-content mui-scroll-wrapper">
	...
	<div  style="background:#FFF;border-bottom:1px solid #CCC;">
       ...
       <div style="width:25%;display:inline-block;text-align: center;float:left;line-height:2rem;">
            <eq name="v.pay_status" value="0">未充值</eq>
            <eq name="v.pay_status" value="1">已充值</eq>
       </div>
       <div style="width:25%;display:inline-block;text-align: center;float:left;line-height:2rem;">{{$v.pay_time}}</div>
        <div style="width:25%;display:inline-block;text-align: center;float:left;line-height:2rem;">
