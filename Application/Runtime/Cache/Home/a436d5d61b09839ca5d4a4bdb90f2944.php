...
<body style="background:#f24646;">
    ...
    <img src="/Public/Images/Home/qr1.png" style="width: 40%; margin: 0 auto; display: block;;"/>
    <p style="text-align: center; font-size:13px; margin-bottom:2rem; line-height: 30px; color:#fff; letter-spacing: 1px;">Android设备下载</p>
    <img src="/Public/Images/Home/qr2.png" style="width: 40%; margin: 0 auto; display: block;;"/>
