...
<body style="background:url(/Public/Images/Home/bg2.jpg) no-repeat;height:100%; background-size:100% auto;">
<div class="container padding-bottom-5">
  ...
  <div class="row">
    ...
    <div class="col-xs-12 line-height-5 media1" style="line-height:6rem;font-size:1.2rem !important">
      ...
      <div class="col-xs-9 padding-0">
        <input type="text" name="tui_phone" id="tui_phone" placeholder="请输入邀请码" class="form-input lidl" style="font-size:1rem !important;" value="<?php echo ($output["invite"]); ?>">
      </div>
    </div>
