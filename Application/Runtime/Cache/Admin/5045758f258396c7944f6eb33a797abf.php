        	...
        	<form action="" method="get">
                ...
                <div class="col-lg-3">
                	<div class="input-group input-group-sm">
                        ...
                        <input type="text" name="parent_id" value="<?php echo ($where["parent_id"]); ?>" class="form-control">
                    </div>
                </div>
        ...
        <div class="col-lg-12">
            <table class="table table-striped bg-ff">
                ...
                <?php if(is_array($output)): $i = 0; $__LIST__ = $output;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$o): $mod = ($i % 2 );++$i;?><tr <?php if(($mod) == "1"): ?>class="warning"<?php endif; ?> >
                    ...
                    <td>
                    	<?php if(($o["tui_type"]) == "0"): ?>普通代理<?php endif; ?>
                        <?php if(($o["tui_type"]) == "1"): ?>高级代理<?php endif; ?>
                    </td>
                    <td>
                    	<?php if(($o["tui_type"]) == "0"): ?><a href="/Admin/user/set_type?id=<?php echo ($o["id"]); ?>&type=1">设为高级代理</a><?php endif; ?>
                        <?php if(($o["tui_type"]) == "1"): ?><a href="/Admin/user/set_type?id=<?php echo ($o["id"]); ?>&type=0">设为普通代理</a><?php endif; ?>
                        
                        |
                        
                        <a href="/Admin/user/user_one?id=<?php echo ($o["id"]); ?>">下级</a>

                        |

                        <a href="/Admin/user/bank?id=<?php echo ($o["id"]); ?>">修改银行卡</a>
                    </td>
