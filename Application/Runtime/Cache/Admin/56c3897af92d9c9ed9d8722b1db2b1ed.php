...
<div class="col-lg-10 pd0 pl20 right">
    ...
    <div class="row pt20 pb20 lh30">
        ...
        <div class="col-lg-6 text-right"> <a href="<?php echo U('Admin/Goods/add');?>">
    ...
    <div class="row pt20">
        <div class="col-lg-12">
            <table class="table table-striped bg-ff">
                ...
                <tbody>
                <?php if(is_array($output['rowGoods'])): $i = 0; $__LIST__ = $output['rowGoods'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$o): $mod = ($i % 2 );++$i;?><tr <?php if(($mod) == "1"): ?>class="warning"<?php endif; ?> >
                    <td><?php echo ($o["id"]); ?></td>
                    <td><?php echo ($o["name"]); ?></td>
                    <td><img src="<?php echo ($o["img_url"]); ?>" /></td>
                    <td><a href="<?php echo U('Goods/edit', array('id'=>$o['id']));?>">编辑</a></td>
