        	...
        	<form action="" method="get">
                ...
                <div class="col-lg-3">
                	<div class="input-group input-group-sm">
                        ...
                        <input type="text" name="award_code" value="<?php echo ($where["award_code"]); ?>" class="form-control">
                    </div>
                </div>
        ...
        <div class="col-lg-12">
            <table class="table table-striped bg-ff">
                ...
                <?php if(is_array($output['rowsOrder'])): $i = 0; $__LIST__ = $output['rowsOrder'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$o): $mod = ($i % 2 );++$i;?><tr <?php if(($mod) == "1"): ?>class="warning"<?php endif; ?> >
                    ...
                    <td>
                        <?php if(($o["is_get"]) == "0"): ?><a href="/admin/reward/set?id=<?php echo ($o["id"]); ?>">未兑</a><?php endif; ?>
                        <?php if(($o["is_get"]) == "1"): ?>已兑<?php endif; ?>
                    </td>
