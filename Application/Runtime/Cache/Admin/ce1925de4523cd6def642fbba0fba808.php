                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="input-group input-group-sm" style="width:500px;">
                            ...
                            <input type="text" name="tip_top" class="form-control" style="width:100%;" value="<?php echo ($output["rowSet"]["tip_top"]); ?>">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12"  style="margin-top:10px;">
                        <div class="input-group input-group-sm" style="width:500px;">
                            ...
                            <input type="text" name="tip_center" class="form-control" style="width:100%;" value="<?php echo ($output["rowSet"]["tip_center"]); ?>">
                        </div>
                    </div>
                </div>
                ...
                <div class="row" style="margin-top:10px;">
                    <div class="col-lg-5">
                        <div class="input-group input-group-sm">
                            ...
                            <script id="myEditor" name="rule" type="text/plain"><?php echo ($output["rowSet"]["rule"]); ?></script>
