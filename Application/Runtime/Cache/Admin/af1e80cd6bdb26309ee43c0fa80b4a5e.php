...
<div class="col-lg-10 pd0 pl20 right">
   ...
   <!--button-box start-->
      ...
      <input type="hidden" name="id" value="<?php echo ($output["goods"]["id"]); ?>" />
        <div class="pt20 pb20">
                ...
                <div class="row">
                    <div class="col-lg-5">
                        <div class="input-group input-group-sm">
                            ...
                            <input type="text" name="name" value="<?php echo ($output["goods"]["name"]); ?>" class="form-control">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-5">
                        <div class="input-group input-group-sm">
                            ...
                            <select name="cata_id" class="form-control">
                            	<?php if(is_array($output["cata"])): foreach($output["cata"] as $key=>$v): ?><option  value="<?php echo ($v["id"]); ?>" <?php if(($output['goods']['cata_id']) == $v['id']): ?>selected<?php endif; ?> ><?php echo ($v["name"]); ?></option><?php endforeach; endif; ?>
                            </select>
