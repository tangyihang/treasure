        	...
        	<p>
				...
				<div id="payPassword_container" class="alieditContainer clearfix" data-busy="0">
					<div style="display: inline-block;" class="i-block" data-error="i_error">
						...
						<span style="padding:.05rem; display: block;font-size: .15rem;color: #999;">请在此输入</span>
	        	...
	        	<hr style="width: .6rem;margin-left: .1rem;display: inline-block;height: .01rem;border: none;border-bottom:1px solid #eee;"/>
	          	...
	          	<hr style="width: .6rem;margin-right: .1rem;display: inline-block;height: .01rem;border: none;border-bottom:1px solid #eee;"/>
           		...
           		<div style="width:100%;height:.4rem;line-height:.4rem;">
					<a style="display: inline-block; border-radius:.05rem; background: #f24646; color: #fff; height:.4rem; font-size:.15rem;border: none;width: 45%;margin: .01rem auto;" href="javascript:;" onclick="register();">确认</a>
					<a style="display: inline-block; border-radius:.05rem; background: #f24646; color: #fff; height:.4rem; font-size:.15rem; border: none;width: 45%;margin: .01rem auto;" href="" >重置</a>
       			</div>
       </div> 
    </div>
    </div>
