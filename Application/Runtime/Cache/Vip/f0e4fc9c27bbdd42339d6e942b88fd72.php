...
<div id="pullrefresh" class="mui-content mui-scroll-wrapper">
	...
	<div  style="background:#FFF;border-bottom:1px solid #CCC;">
       ...
       <div style="width:25%;display:inline-block;text-align: center;line-height:2rem;float:left;"><?php echo ($v["money"]); ?></div>
       <div style="width:25%;display:inline-block;text-align: center;float:left;line-height:2rem;">
            <?php if(($v["pay_status"]) == "0"): ?>未充值<?php endif; ?>
            <?php if(($v["pay_status"]) == "1"): ?>已充值<?php endif; ?>
       </div>
       <div style="width:25%;display:inline-block;text-align: center;float:left;line-height:2rem;"><?php echo ($v["pay_time"]); ?></div>
        <div style="width:25%;display:inline-block;text-align: center;float:left;line-height:2rem;">
            <?php if(($v["pay_type"]) == "1"): ?>支付宝<?php endif; ?>
            <?php if(($v["pay_type"]) == "0"): ?>微信<?php endif; ?>
        </div>
        <div style="clear:both;"></div>
    </div>
    <!--
