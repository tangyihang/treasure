<body>
    ...
    <div class="mui-row" style="position:fixed;left:0px;top:1.8rem;width:100%;line-height:2.5rem;text-align:center;">
			...
			<div class="mui-col-sm-4 mui-col-xs-4 jump" data-url="/rank/day7" style="background:#f5f5f5;color:#eb5c4b;border-right:1px solid #FFFFFF;">7日</div>
			<div class="mui-col-sm-4 mui-col-xs-4 jump" data-url="/rank/day30" style="background:#f24646;color:#FFF;">30日</div>
		</div>
	<!--
    	描述：跑马灯结束
    -->
