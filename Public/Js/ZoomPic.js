...
{var _this=this;this.wrap=typeof id==="string"?document.getElementById(id):id;this.oUl=this.wrap.getElementsByTagName("ul")[0];this.aLi=this.wrap.getElementsByTagName("li");this.prev=this.wrap.getElementsByTagName("pre")[0];this.next=this.wrap.getElementsByTagName("pre")[1];this.timer=null;this.aSort=[];this.iCenter=3;this._doPrev=function(){return _this.doPrev.apply(_this)};this._doNext=function(){return _this.doNext.apply(_this)};this.options=[{width:230,height:237,top:100,left:0,zIndex:1},{width:230,height:237,top:100,left:0,zIndex:2},{width:230,height:237,top:100,left:232,zIndex:3},{width:350,height:310,top:64,left:383,zIndex:4},{width:230,height:237,top:100,left:655,zIndex:3},{width:230,height:237,top:100,left:885,zIndex:2},{width:230,height:237,top:100,left:455,zIndex:1},];for(var i=0;i<this.aLi.length;i++)this.aSort[i]=this.aLi[i];this.aSort.unshift(this.aSort.pop());this.setUp();this.addEvent(this.prev,"click",this._doPrev);this.addEvent(this.next,"click",this._doNext);this.doImgClick();this.timer=setInterval(function()
